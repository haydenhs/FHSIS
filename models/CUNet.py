...
class CUNet(nn.Module):
    def __init__(self):
        ...
        self.num_filters = 64
        self.kernel_size = 9
        self.up = torch.nn.Upsample(scale_factor=32, mode='bilinear', align_corners=True)
        self.net_u = Prediction(num_channels=31)
        ...
        self.net_v = Prediction(num_channels=3)
        ...
        self.net_z = Prediction(num_channels=31+3)
