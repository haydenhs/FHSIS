...
def test(args):
    ...
    test_name = args.dataset + '_' + args.lr_type + '_' + args.rgb_type + '_x' + str(args.sr_factor) + '_' + str(args.factor) + '_' + str(args.num_basis)
    # model
    print('===> Building model')
    model = Net(factor=args.factor, n_basis=args.num_basis)
    #model = FPS()
    ...
    with torch.no_grad():
        ...
        print("===> {}\t Testing Complete: Avg. RMSE: {:.6f}, Avg. PSNR: {:.2f}, Avg. SSIM: {:.2f}".format(
